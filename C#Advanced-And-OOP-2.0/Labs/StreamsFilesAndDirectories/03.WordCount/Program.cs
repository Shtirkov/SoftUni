...
namespace _03.WordCount
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                var splittedWords = reader.ReadToEnd().Split().ToList();
            ...
            var plainTextSplitted = plainText.ToString().Split(" ", StringSplitOptions.RemoveEmptyEntries);

            foreach (var word in plainTextSplitted)
            {
